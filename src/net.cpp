...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Domicoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"domicointools.com", "dnsseed.domicointools.com"},
    {"domicoinpool.org", "dnsseed.domicoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"domicointools.com", "testnet-seed.domicointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Domicoin is probably already running."), addrBind.ToString().c_str());
        else
